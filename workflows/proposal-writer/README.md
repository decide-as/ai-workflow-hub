...
<div align="center">
  <a href="https://github.com/decide-as/proposal-writer">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Proposal-Writer</h3>

  <p align="center">
    Structures commercial proposals from scope notes and pricing into polished client-facing documents
    <br />
    <a href="https://github.com/decide-as/proposal-writer"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/proposal-writer
cd proposal-writer
python3 -m venv .venv
...
```
proposal-writer/
├── src/proposal_writer/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/proposal-writer/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/proposal-writer](https://github.com/decide-as/proposal-writer)
