# Fiken / MVA FAQ — registering foreign & travel purchases

Reference for how the user should register each line of the **bookkeeping
summary** (this summary is what they enter into their accounts). The firm is
VAT-registered (mva-registrert). Cite the relevant point when recommending how to
register a transaction — especially foreign-currency travel receipts, which
almost always fall under **point 4**.

> Quick rule for travel: a receipt paid in foreign currency for something
> consumed abroad (taxi, Tube, groceries, restaurant) → **point 4**: mva-kode
> **"Ingen"**, no VAT deduction, and enter the **NOK actually drawn from the
> account**.
