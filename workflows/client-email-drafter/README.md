...
<div align="center">
  <a href="https://github.com/decide-as/client-email-drafter">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Client-Email-Drafter</h3>

  <p align="center">
    Turns bullet-point notes into polished professional client-facing emails
    <br />
    <a href="https://github.com/decide-as/client-email-drafter"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/client-email-drafter
cd client-email-drafter
python3 -m venv .venv
...
├── src/client_email_drafter/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/client-email-drafter/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/client-email-drafter](https://github.com/decide-as/client-email-drafter)
