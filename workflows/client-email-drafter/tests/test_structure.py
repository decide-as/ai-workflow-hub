"""Project structure and consistency tests for Client-Email-Drafter.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Client-Email-Drafter" in readme or "client-email-drafter" in readme
