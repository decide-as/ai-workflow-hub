# Architecture — Task-Prioritiser

> This document describes the high-level architecture of Task-Prioritiser.
...
|---|---|---|
| Core logic | `src/task_prioritiser/` | Business logic and orchestration |
