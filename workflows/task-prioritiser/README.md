...
<div align="center">
  <a href="https://github.com/decide-as/task-prioritiser">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Task-Prioritiser</h3>

  <p align="center">
    Scores and ranks backlog items using ICE and RICE frameworks with strategic alignment context
    <br />
    <a href="https://github.com/decide-as/task-prioritiser"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/task-prioritiser
cd task-prioritiser
python3 -m venv .venv
...
```
task-prioritiser/
├── src/task_prioritiser/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/task-prioritiser/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/task-prioritiser](https://github.com/decide-as/task-prioritiser)
