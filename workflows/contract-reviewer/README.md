...
<div align="center">
  <a href="https://github.com/decide-as/contract-reviewer">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Contract-Reviewer</h3>

  <p align="center">
    Analyses contracts for red flags and generates prioritised risk summaries with suggested redlines
    <br />
    <a href="https://github.com/decide-as/contract-reviewer"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/contract-reviewer
...
```
contract-reviewer/
├── src/contract_reviewer/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/contract-reviewer/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/contract-reviewer](https://github.com/decide-as/contract-reviewer)
