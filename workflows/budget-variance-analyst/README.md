...
<div align="center">
  <a href="https://github.com/decide-as/budget-variance-analyst">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Budget-Variance-Analyst</h3>

  <p align="center">
    Compares actuals against approved budget per cost centre and generates board-ready variance commentary
    <br />
    <a href="https://github.com/decide-as/budget-variance-analyst"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/budget-variance-analyst
cd budget-variance-analyst
python3 -m venv .venv
...
├── src/budget_variance_analyst/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/budget-variance-analyst/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/budget-variance-analyst](https://github.com/decide-as/budget-variance-analyst)
