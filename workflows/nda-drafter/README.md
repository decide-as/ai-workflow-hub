...
<div align="center">
  <a href="https://github.com/decide-as/nda-drafter">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Nda-Drafter</h3>

  <p align="center">
    Generates balanced mutual NDAs from counterparty details and negotiation preferences
    <br />
    <a href="https://github.com/decide-as/nda-drafter"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/nda-drafter
cd nda-drafter
python3 -m venv .venv
...
See the [open issues](https://github.com/decide-as/nda-drafter/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/nda-drafter](https://github.com/decide-as/nda-drafter)
