...
This rule defines what "world-class" means across development stages.
...
When asked to assess quality, always respond in this structure.

## Stage
State the current stage used for evaluation.

## Scope
State the scope being judged.
Examples:
- this task
- this worktree
- this branch
- this PR
- the touched modules and their direct interfaces
...
## Summary
A brief, blunt assessment.

## Checklist
Report PASS, FAIL, or N/A for all relevant sections.

## Weaknesses blocking current-stage world-class status
List every issue still preventing a world-class verdict for the current stage.
If none, say:
- None of significance

## Weaknesses blocking advancement
List every issue preventing movement to the next stage.
If none, say:
- None of significance

## Out-of-scope issues noticed
List unrelated legacy or wider-repo issues noticed during review that are not blockers for this work.
If none, say:
- None of significance

## Next improvements
State the exact improvements required now.
