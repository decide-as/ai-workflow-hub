"""Project structure and consistency tests for Team-Briefing-Generator.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Team-Briefing-Generator" in readme or "team-briefing-generator" in readme
