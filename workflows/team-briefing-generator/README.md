...
<div align="center">
  <a href="https://github.com/decide-as/team-briefing-generator">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Team-Briefing-Generator</h3>

  <p align="center">
    Produces concise weekly team briefings from Slack digests and completed task lists
    <br />
    <a href="https://github.com/decide-as/team-briefing-generator"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/team-briefing-generator
cd team-briefing-generator
python3 -m venv .venv
...
├── src/team_briefing_generator/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/team-briefing-generator/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/team-briefing-generator](https://github.com/decide-as/team-briefing-generator)
