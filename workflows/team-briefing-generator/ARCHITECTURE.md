# Architecture — Team-Briefing-Generator

> This document describes the high-level architecture of Team-Briefing-Generator.
...
|---|---|---|
| Core logic | `src/team_briefing_generator/` | Business logic and orchestration |
