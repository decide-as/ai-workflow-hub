"""Project structure and consistency tests for Meeting-Notes-Summariser.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Meeting-Notes-Summariser" in readme or "meeting-notes-summariser" in readme
