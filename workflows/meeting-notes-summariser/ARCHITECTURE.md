# Architecture — Meeting-Notes-Summariser

> This document describes the high-level architecture of Meeting-Notes-Summariser.
...
|---|---|---|
| Core logic | `src/meeting_notes_summariser/` | Business logic and orchestration |
