# Architecture — Travel-Expense-Report

> This document describes the high-level architecture of Travel-Expense-Report.
...
|---|---|---|
| Core logic | `src/travel_expense_report/` | Business logic and orchestration |
