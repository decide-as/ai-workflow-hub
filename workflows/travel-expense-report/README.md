...
<div align="center">
  <a href="https://github.com/decide-as/travel-expense-report">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Travel-Expense-Report</h3>

  <p align="center">
    Processes travel receipts and generates formatted expense reports with policy-compliance checking
    <br />
    <a href="https://github.com/decide-as/travel-expense-report"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/travel-expense-report
cd travel-expense-report
python3 -m venv .venv
...
├── src/travel_expense_report/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/travel-expense-report/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/travel-expense-report](https://github.com/decide-as/travel-expense-report)
