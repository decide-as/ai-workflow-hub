"""Project structure and consistency tests for Travel-Expense-Report.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Travel-Expense-Report" in readme or "travel-expense-report" in readme
