...
<div align="center">
  <a href="https://github.com/decide-as/project-status-reporter">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Project-Status-Reporter</h3>

  <p align="center">
    Generates weekly RAG status reports from ticket data for internal teams and clients
    <br />
    <a href="https://github.com/decide-as/project-status-reporter"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/project-status-reporter
...
├── src/project_status_reporter/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/project-status-reporter/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/project-status-reporter](https://github.com/decide-as/project-status-reporter)
