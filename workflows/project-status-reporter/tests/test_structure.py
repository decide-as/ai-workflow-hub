"""Project structure and consistency tests for Project-Status-Reporter.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Project-Status-Reporter" in readme or "project-status-reporter" in readme
