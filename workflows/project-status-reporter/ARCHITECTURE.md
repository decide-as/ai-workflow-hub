# Architecture — Project-Status-Reporter

> This document describes the high-level architecture of Project-Status-Reporter.
...
|---|---|---|
| Core logic | `src/project_status_reporter/` | Business logic and orchestration |
