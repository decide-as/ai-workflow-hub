...
<div align="center">
  <a href="https://github.com/decide-as/gdpr-compliance-checker">
    <img src="assets/logo.png" alt="Logo" height="150">
  </a>

<h3 align="center">Gdpr-Compliance-Checker</h3>

  <p align="center">
    Reviews product features and data flows against GDPR obligations and produces remediation plans
    <br />
    <a href="https://github.com/decide-as/gdpr-compliance-checker"><strong>Explore »</strong></a>
  </p>
...
```bash
git clone https://github.com/decide-as/gdpr-compliance-checker
...
├── src/gdpr_compliance_checker/         # Source code
├── tests/                  # Test suite
...
See the [open issues](https://github.com/decide-as/gdpr-compliance-checker/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/decide-as/gdpr-compliance-checker](https://github.com/decide-as/gdpr-compliance-checker)
