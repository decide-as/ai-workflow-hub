"""Project structure and consistency tests for Gdpr-Compliance-Checker.
...
class TestReadmeHealth:
    ...
    def test_has_project_name(self, readme: str) -> None:
        assert "Gdpr-Compliance-Checker" in readme or "gdpr-compliance-checker" in readme
