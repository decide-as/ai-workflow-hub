...
export function RunModal({
  ...
  const showOptions =
    runnerOptions.length > 0 && (phase === "running" || phase === "preview");
            ...
            {runnerOptions.map((opt) => {
              ...
              return (
                ...
                >
                  {opt.optional && (
                    <input
                      ...
                      onChange={(e) =>
                        commit({
                          ...optValues,
                          [opt.key]: { ...v, enabled: e.target.checked },
                        })
                      }
                  ...
                  <span
                    className={
                      opt.optional && !v.enabled ? "text-zinc-500" : ""
                    }
                  >
                    {opt.label}
                  </span>
                  <input
                    ...
                    onChange={(e) =>
                      setOptValues({
                        ...optValues,
                        [opt.key]: { ...v, value: Number(e.target.value) },
                      })
                    }
                    onBlur={() => commit(optValues)}
                    onKeyDown={(e) => {
                      if (e.key === "Enter") commit(optValues);
                    }}
